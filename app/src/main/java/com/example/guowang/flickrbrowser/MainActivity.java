...
public class MainActivity extends BaseActivity implements GetFlickrJsonData.OnDataAvailable,
    ...
    protected void onResume() {
        ...
        GetFlickrJsonData getFlickrJsonData = new GetFlickrJsonData(
                this, "https://api.flickr.com/services/feeds/photos_public.gne",
                "en-us", true);
//        getFlickrJsonData.executeOnSameThread("kpop, twice");
        getFlickrJsonData.execute("kpop, twice");
    ...
    public void onDataAvailable(List<Photo> data, DownloadStatus status) {
        ...
        if (status.equals(DownloadStatus.OK)) {
